...
const quizData = [
  {
    question: "淡江大學教育科技系的英文名稱是什麼？",
    type: "multiple-choice",
    options: {
      A: "Department of Educational Technology and Media",
      B: "Department of Instructional Design and Technology",
      C: "Department of Educational Technology",
      D: "Department of Digital Learning and Education"
    },
    answer: "C"
  },
  {
    question: "教育科技系最主要的教學方向不包括以下哪一項？",
    type: "multiple-choice",
    options: {
      A: "數位教材設計",
      B: "教學媒體製作",
  ...
  {
    question: "教育科技系的必修課程中，哪一門課是強調教學設計與發展的？",
    type: "multiple-choice",
    options: {
      A: "數位遊戲設計",
      B: "教學設計",
  ...
  {
    question: "教育科技系曾參與製作哪一類型的創新教學產品？",
    type: "multiple-choice",
    options: {
      A: "AI晶片",
      B: "電動車模組",
  ...
  {
    question: "淡江大學著名的校園地標之一「海報牆」主要用途是？",
    type: "multiple-choice",
    options: {
      A: "宣傳活動與社團資訊",
      B: "藝術創作展示",
  ...
  {
    question: "教育科技系訓練學生具備「_________」與數位教學整合的能力，能應用於教學與企業訓練。",
